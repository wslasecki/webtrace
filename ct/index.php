...
<script src="tracer/ev.js"></script>
    ...
    <DIV ID="wa_navigator">
      ...
      <div id="wa_browser_interface">
	        <table width="100%">
	            <tr width="100%">
	              ...
	              <form onSubmit="javascript:nextNodeContentFinder(this);return false;" style="margin: 0; padding: 0; display: inline;" autocomplete="off">
	                ...
	                <td>
	                    <input class="inputbutton" id="find_next_button" name="find_next_button" type="button" value="<?php echo wa_gettext('Exec') ?>" onclick='nextNodeContentFinder(this); return false;'/>
	                </td>
	              </form>
	            </tr>
	        </table>
        ...
        <div id="wa_text_display_container">
          <span id="wa_text_display" style="width: 100%; margin: 0; padding: 0.1em; font-size: 3em; color: #0E6; font-weight: bold;"><?php echo wa_gettext("Crowdtana") ?></span>
        </div>
